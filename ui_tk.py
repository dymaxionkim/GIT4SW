...
class GIT4SWApp(tk.Tk):
    ...
    def create_help_view(self):
        ...
        help_text = (
            "For detailed usage instructions, please refer to the README.md file in the project directory.\n\n"
            "Welcome to GIT4SW, a dedicated Git version control client for SolidWorks!\n\n"
            "Here is a quick reference guide on how to work with this tool:\n\n"
            "1. Automatic File Locking\n"
            "   - When you open a CAD file (.sldprt, .sldasm, .slddrw) in SolidWorks from your active workspace,\n"
            "     the app automatically locks the file on the remote Git server (using Git LFS locks).\n"
            "   - This prevents other team members from modifying it while you work.\n"
            "   - When you close the file in SolidWorks, the app automatically releases the lock.\n\n"
            "2. File Manager Actions\n"
            "   - Lock (Checkout): Manually lock a file and check it out.\n"
            "   - Unlock: Release your lock on a file.\n"
            "   - Force Unlock: Release another designer's lock if necessary.\n"
            "   - Discard: Undo local unsaved modifications on selected files.\n"
            "   - eDrawings / Solidworks: Open files directly in respective programs.\n\n"
            "3. Saving & Uploading Versions\n"
            "   - Upload Selected File Version: Stages, commits, and pushes selected files to your branch.\n"
            "   - Upload Every Files Version: Stages, commits, and pushes all local workspace changes at once.\n\n"
            "4. Branch Management & Sync\n"
            "   - Get Latest Version (Sync): Dynamically fetches and pulls remote updates for your active branch.\n"
            "   - Merge main branch into current branch: Merges remote/local 'main' branch updates into your current developer branch.\n"
            "   - Make my branch: Resolves your account name, creates a developer branch locally/remotely, and switches to it so you can work safely without disrupting 'main'."
        )
